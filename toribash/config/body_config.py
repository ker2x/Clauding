...
def _make_default_body() -> BodyConfig:
    ...
    # Increased motor_max_force for better standing ability
    joints = [
        # Neck: head to chest
        ...
        JointDef("hip_l", "stomach", "upper_leg_l",
                 ...
                 angle_min=-1.5, angle_max=2.0,
                  motor_rate=12.0, motor_max_force=1000000.0),  # Quadrupled
        # Left knee
        JointDef("knee_l", "upper_leg_l", "lower_leg_l",
                 (0, -17), (0, 16),
                 angle_min=-0.1, angle_max=2.5,
                 motor_rate=15.0, motor_max_force=1000000.0),  # Quadrupled
        # Left ankle
