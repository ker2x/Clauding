#!/usr/bin/env python3
"""Run a Kouhai program: compile and execute."""
...
from kouhai.compiler import run_file, compile_file, CompileError


def main():
    if len(sys.argv) < 2:
        print("Usage: run.py <file.kou> [--ir] [--link lib ...]", file=sys.stderr)
        sys.exit(1)
