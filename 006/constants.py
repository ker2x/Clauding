...
STATE_DIM = 67  # Vector mode state dimension (car state + track geometry + lookahead)
...
DEFAULT_EVAL_FREQUENCY = 100      # Evaluate every N episodes
...
DEFAULT_EVAL_EPISODES = 5          # Episodes for standard evaluation
...
DEFAULT_NUM_AGENTS = 8             # Number of parallel agents
DEFAULT_SELECTION_FREQUENCY = 50   # Episodes between tournaments
DEFAULT_ELITE_COUNT = 1            # Top N agents preserved (1=winner-takes-all)
...
DEFAULT_STATIONARY_PATIENCE = 50
DEFAULT_STATIONARY_MIN_STEPS = 50

# Episode constraints
DEFAULT_MAX_EPISODE_STEPS = 2500  # Max steps per episode (prevents infinite loops)
DEFAULT_MIN_EPISODE_STEPS = 150   # Min steps before penalty applied
