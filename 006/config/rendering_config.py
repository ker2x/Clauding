...
# These can be removed once all code is migrated to use RenderingConfig
VIDEO_W = DEFAULT_RENDERING_CONFIG.video.VIDEO_W
VIDEO_H = DEFAULT_RENDERING_CONFIG.video.VIDEO_H
WINDOW_W = DEFAULT_RENDERING_CONFIG.video.WINDOW_W
WINDOW_H = DEFAULT_RENDERING_CONFIG.video.WINDOW_H
FPS = DEFAULT_RENDERING_CONFIG.video.FPS

SCALE = DEFAULT_RENDERING_CONFIG.camera.SCALE
ZOOM = DEFAULT_RENDERING_CONFIG.camera.ZOOM
PLAYFIELD = DEFAULT_RENDERING_CONFIG.camera.PLAYFIELD
TRACK_RAD = DEFAULT_RENDERING_CONFIG.camera.track_rad

TRACK_DETAIL_STEP = DEFAULT_RENDERING_CONFIG.track_visuals.TRACK_DETAIL_STEP
TRACK_TURN_RATE = DEFAULT_RENDERING_CONFIG.track_visuals.TRACK_TURN_RATE
TRACK_WIDTH = DEFAULT_RENDERING_CONFIG.track_visuals.TRACK_WIDTH
BORDER = DEFAULT_RENDERING_CONFIG.track_visuals.BORDER
BORDER_MIN_COUNT = DEFAULT_RENDERING_CONFIG.track_visuals.BORDER_MIN_COUNT
GRASS_DIM = DEFAULT_RENDERING_CONFIG.track_visuals.GRASS_DIM
MAX_SHAPE_DIM = DEFAULT_RENDERING_CONFIG.track_visuals.max_shape_dim

NEAR_TRACK_THRESHOLD = DEFAULT_RENDERING_CONFIG.friction_detection.NEAR_TRACK_THRESHOLD
SPATIAL_CHECK_RANGE = DEFAULT_RENDERING_CONFIG.friction_detection.SPATIAL_CHECK_RANGE

MAX_VELOCITY = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_VELOCITY
MAX_ANGULAR_VEL = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_ANGULAR_VEL
MAX_ACCELERATION = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_ACCELERATION
MAX_CURVATURE = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_CURVATURE
MAX_SLIP_RATIO = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_SLIP_RATIO
MAX_VERTICAL_FORCE = DEFAULT_RENDERING_CONFIG.state_normalization.MAX_VERTICAL_FORCE
