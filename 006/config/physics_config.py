...
# For backward compatibility with old constant-based code
# These can be removed once all code is migrated to use PhysicsConfig
MASS = DEFAULT_PHYSICS_CONFIG.vehicle.MASS
LENGTH = DEFAULT_PHYSICS_CONFIG.vehicle.LENGTH
WIDTH = DEFAULT_PHYSICS_CONFIG.vehicle.WIDTH
LF = DEFAULT_PHYSICS_CONFIG.vehicle.LF
LR = DEFAULT_PHYSICS_CONFIG.vehicle.LR
CG_HEIGHT = DEFAULT_PHYSICS_CONFIG.vehicle.CG_HEIGHT

TIRE_RADIUS = DEFAULT_PHYSICS_CONFIG.tire.TIRE_RADIUS
TIRE_WIDTH = DEFAULT_PHYSICS_CONFIG.tire.TIRE_WIDTH
INERTIA = DEFAULT_PHYSICS_CONFIG.tire.INERTIA

PACEJKA_B_LAT = DEFAULT_PHYSICS_CONFIG.pacejka.B_LAT
PACEJKA_C_LAT = DEFAULT_PHYSICS_CONFIG.pacejka.C_LAT
PACEJKA_D_LAT = DEFAULT_PHYSICS_CONFIG.pacejka.D_LAT
PACEJKA_E_LAT = DEFAULT_PHYSICS_CONFIG.pacejka.E_LAT
PACEJKA_B_LON = DEFAULT_PHYSICS_CONFIG.pacejka.B_LON
PACEJKA_C_LON = DEFAULT_PHYSICS_CONFIG.pacejka.C_LON
PACEJKA_D_LON = DEFAULT_PHYSICS_CONFIG.pacejka.D_LON
PACEJKA_E_LON = DEFAULT_PHYSICS_CONFIG.pacejka.E_LON

ENGINE_POWER = DEFAULT_PHYSICS_CONFIG.drivetrain.ENGINE_POWER
MAX_TORQUE_PER_WHEEL = DEFAULT_PHYSICS_CONFIG.drivetrain.MAX_TORQUE_PER_WHEEL
POWER_TRANSITION_OMEGA = DEFAULT_PHYSICS_CONFIG.drivetrain.POWER_TRANSITION_OMEGA
STARTUP_ACCEL = DEFAULT_PHYSICS_CONFIG.drivetrain.STARTUP_ACCEL
MAX_BRAKE_TORQUE_FRONT = DEFAULT_PHYSICS_CONFIG.drivetrain.MAX_BRAKE_TORQUE_FRONT
MAX_BRAKE_TORQUE_REAR = DEFAULT_PHYSICS_CONFIG.drivetrain.MAX_BRAKE_TORQUE_REAR

RHO_AIR = DEFAULT_PHYSICS_CONFIG.aerodynamics.RHO_AIR
FRONTAL_AREA = DEFAULT_PHYSICS_CONFIG.aerodynamics.FRONTAL_AREA
CD_CAR = DEFAULT_PHYSICS_CONFIG.aerodynamics.CD_CAR
C_ROLL_RESISTANCE = DEFAULT_PHYSICS_CONFIG.aerodynamics.C_ROLL_RESISTANCE

MAX_STEER_ANGLE = DEFAULT_PHYSICS_CONFIG.steering.MAX_STEER_ANGLE
STEER_RATE = DEFAULT_PHYSICS_CONFIG.steering.STEER_RATE

BASE_FRICTION = DEFAULT_PHYSICS_CONFIG.friction.BASE_FRICTION
GRASS_FRICTION = DEFAULT_PHYSICS_CONFIG.friction.GRASS_FRICTION
