#!/usr/bin/env python3
"""Compile a Senpai program to a binary or LLVM IR."""
...
from senpai.compiler import compile_file, CompileError


def main():
    if len(sys.argv) < 2:
        print("Usage: compile.py <file.sen> [-o output] [--ir]", file=sys.stderr)
        sys.exit(1)
